...
import static utils.constans.ActorConstans.ACTOR_DEFAULT;
...
public class Hook {
    ...
    @Dado("^que el (.*) se encuentre en la pagina de Metis$")
    public void queElUsuarioSeEncuentreEnLaPaginaDeMetis(String actor) {
